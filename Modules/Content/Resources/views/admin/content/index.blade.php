<x-admin-layout>
    <x-slot name="header">
        ...
        @if (!$collection->count() || $nav->type->multiple())
            <x-admin.page-button :href="route('admin.contents.create', $nav->id)">
                Cadastrar novo
            </x-admin.page-button>
        @endif
    </x-slot>
                ...
                @forelse ($collection as $item)
                    <tr class="bg-white border-b">
                        ...
                        <x-admin.table-actions-td>
                            <x-admin.table-action :href="route('admin.contents.edit', $item->id)" title="Editar">
                                <i class="text-base ti ti-edit"></i>
                            </x-admin.table-action>
                            <x-admin.table-action :href="route('admin.contents.destroy', $item->id)" title="Excluir" :destroy="true">
