<x-public.layout.app>
    <div class="p-6 space-y-6 bg-white border shadow-sm sm:rounded-lg">
        <x-admin.layout.sections.list-section>
            <x-admin.layout.sections.form :action="route('customer.store')" x-data="{!! '{personFisica: ' . ($personFisica ? 'true' : 'false') . '}' !!}">
                <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-3">
                    ...
                    <x-admin.layout.sections.form-label inpName="rg" title="RG">
                        <x-admin.layout.sections.form-input inpName="rg" placeholder="Identidade"
                ...
                <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-3">
                    ...
                    @else
                        <x-admin.layout.sections.form-label inpName="password" title="Senha do Usuário">
                            <x-admin.layout.sections.form-input inpName="password" type="password"
