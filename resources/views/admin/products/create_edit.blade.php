<x-admin.layout.app>
    ...
    <x-slot name="header">
        ...
        <x-admin.layout.sections.page-button :href="route('admin.products.index')">
            Listar Produtos
        </x-admin.layout.sections.page-button>
    </x-slot>
    <x-admin.layout.sections.list-section id="section" x-data="{!! '{inPromo: ' .
        (!$inPromo ? 'true' : 'false') .
        ', typeOrca: ' .
        ($typeOrca ? 'true' : 'false') .
        ', hasChild: ' .
        ...
        $listChilds->count() .
        '}' !!}">
        <x-admin.layout.sections.form :action="$item->id ? route('admin.products.update', $item->id) : route('admin.products.store')" :editing="(bool) $item->id" :hasFile="true">
            <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-2">
                <x-admin.layout.sections.form-subtitle>Dados do Produto</x-admin.layout.sections.form-subtitle>
                ...
                <x-admin.layout.sections.form-select inpName="product_category_id" title="Categoria Principal" required>
            ...
            <x-admin.layout.sections.form-select id="product_secondary_category_id"
                ...
                @foreach ($categories as $category)
                    ...
                    @if ($category->allChilds())
                        <x-admin.layout.sections.product-category-recursive-option-tree :categories="$category->allChilds"
                            inpName="product_category_id" :treeStr="$category->name" />
                    @endif
                @endforeach
            </x-admin.layout.sections.form-select>
            <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-2">
                <x-admin.layout.sections.form-label inpName="sku" title="Código">
                    <x-admin.layout.sections.form-input inpName="sku" placeholder="SKU" :inpValue="old('sku') ?: $item->sku" required />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label inpName="name" title="Nome">
                    <x-admin.layout.sections.form-input inpName="name" placeholder="Nome do produto" :inpValue="old('name') ?: $item->name"
                        required />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label inpName="ean" title="EAN">
                    <x-admin.layout.sections.form-input inpName="ean" placeholder="Código de barras"
                        :inpValue="old('ean') ?: $item->ean" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label inpName="brand" title="Marca">
                    <x-admin.layout.sections.form-input inpName="brand" placeholder="Marca do produto"
                        :inpValue="old('brand') ?: $item->brand" />
                </x-admin.layout.sections.form-label>
            </x-admin.layout.sections.form-grid>
            <x-admin.layout.sections.form-select inpName="type" title="Tipo do Produto" required
                x-on:change="typeOrca = !typeOrca">
                @foreach (\App\Helpers\ProductTypes::array() as $typeKey => $typeValue)
            ...
            <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-3">
                <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca" inpName="price_cost"
                    title="Custo">
                    <x-admin.layout.sections.form-input inpName="price_cost" placeholder="R$ 0,00" :inpValue="old('price_cost') ?: $item->price_cost"
                        required ::disabled="typeOrca" :disabled="$typeOrca" class="moneyMask" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca" inpName="price"
                    title="Preço">
                    <x-admin.layout.sections.form-input inpName="price" placeholder="R$ 0,00" :inpValue="old('price') ?: $item->price"
                        required ::disabled="typeOrca" :disabled="$typeOrca" class="moneyMask" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca" inpName="weight"
                    title="Peso (kg)">
                    <x-admin.layout.sections.form-input inpName="weight" placeholder="0,000" :inpValue="old('weight') ?: $item->weight" required
                        ::disabled="typeOrca" :disabled="$typeOrca" class="weightMask" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca" inpName="width"
                    title="Largura (cm)">
                    <x-admin.layout.sections.form-input inpName="width" placeholder="0" :inpValue="old('width') ?: $item->width" required
                        ::disabled="typeOrca" :disabled="$typeOrca" class="integerMask" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca" inpName="height"
                    title="Altura (cm)">
                    <x-admin.layout.sections.form-input inpName="height" placeholder="0" :inpValue="old('height') ?: $item->height" required
                        ::disabled="typeOrca" :disabled="$typeOrca" class="integerMask" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca" inpName="depth"
                    title="Comprimento (cm)">
                    <x-admin.layout.sections.form-input inpName="depth" placeholder="0" :inpValue="old('depth') ?: $item->depth" required
                        ::disabled="typeOrca" :disabled="$typeOrca" class="integerMask" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label :xCloak="$typeOrca && !$hasChild" x-show="!typeOrca && hasChild == 0"
                    inpName="stock" title="Estoque">
                    <x-admin.layout.sections.form-input inpName="stock" placeholder="0" :inpValue="old('stock') ?: $item->stock" required
                        ::disabled="typeOrca || hasChild > 0" :disabled="$typeOrca" class="integerMask" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca" inpName="deadline"
                    title="Prazo de Entrega Adicional">
                    <x-admin.layout.sections.form-input inpName="deadline" placeholder="Prazo adicional"
                        :inpValue="old('deadline') ?: $item->deadline" ::disabled="typeOrca" :disabled="$typeOrca" class="integerMask" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca" inpName="inPromo"
                    title="Marcar Produto em Promoção">
                    <x-admin.layout.sections.form-check-toggle inpName="inPromo" title="Promoção"
                        x-on:change="inPromo = !inPromo" alpineDisabledVar="typeOrca" :checked="$inPromo"
                        :disabled="$typeOrca" />
                </x-admin.layout.sections.form-label>
                <x-admin.layout.sections.form-label :xCloak="!$inPromo || $typeOrca" x-show="!inPromo && !typeOrca"
                    inpName="promo_value" title="Preço Promocional">
                    <x-admin.layout.sections.form-input inpName="promo_value" placeholder="R$ 0,00" :inpValue="old('promo_value') ?: $item->promo_value"
                ...
                <x-admin.layout.sections.form-label :xCloak="!$inPromo || $typeOrca" x-show="!inPromo && !typeOrca"
                    ...
                    <x-admin.layout.sections.form-input inpName="promo_date_in" type="datetime-local"
                ...
                <x-admin.layout.sections.form-label :xCloak="!$inPromo || $typeOrca" x-show="!inPromo && !typeOrca"
                    ...
                    <x-admin.layout.sections.form-input inpName="promo_date_end" type="datetime-local"
            ...
            <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-2">
                <x-admin.layout.sections.form-subtitle>Informações do Produto</x-admin.layout.sections.form-subtitle>
                ...
                <x-admin.layout.sections.form-label inpName="meta_description" title="Descrição da Página">
                ...
                <x-admin.layout.sections.form-label inpName="meta_keywords" title="Palavras Chave">
                ...
                <x-admin.layout.sections.form-label inpName="warranty" title="Informações de Garantia">
                    <x-admin.layout.sections.form-input inpName="warranty" placeholder="Garantia"
                        :inpValue="old('warranty') ?: $item->warranty" />
                </x-admin.layout.sections.form-label>
            </x-admin.layout.sections.form-grid>
            <x-admin.layout.sections.form-textarea inpName="text" title="Descrição do Produto"
                placeholder="Descrição" :inpValue="old('text') ?: $item->text" />
            <x-admin.layout.sections.form-label inpName="filenames"
                title="Imagens do Produto (arraste para reordenar)">
                <input type="file" class="filepond" name="filenames[]" multiple>
            </x-admin.layout.sections.form-label>
            <x-admin.layout.sections.form-select id="product_related_id" inpName="product_related_id[]"
                title="Produtos Relacionados" size="1" multiple>
                @foreach ($listRelatedProducts as $related)
                    <x-admin.layout.sections.form-select-option :inpValue="$related->id" :title="$related->name"
                        :selected="true" />
                @endforeach
            </x-admin.layout.sections.form-select>
            <x-admin.layout.sections.form-subtitle>Variações</x-admin.layout.sections.form-subtitle>
            <x-admin.layout.sections.form-select inpName="has_child" title="" required
                ...
                @foreach (\App\Helpers\ProductHasChildTypes::array() as $hasChildKey => $hasChildValue)
                    <x-admin.layout.sections.form-select-option :inpValue="$hasChildKey" :title="$hasChildValue"
                        :selected="(old('has_child') ?: $item->has_child?->value) == $hasChildKey" />
                @endforeach
            </x-admin.layout.sections.form-select>
            <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-2">
                <x-admin.layout.sections.form-select id="product_attribute1_id" required :xCloak="!$hasChild"
                    ...
                    @foreach ($attributes as $attribute)
                        <x-admin.layout.sections.form-select-option :inpValue="$attribute->id" :title="$attribute->name"
                            :selected="(old('product_att1_id') ?: $item->product_att1_id) == $attribute->id" />
                    @endforeach
                </x-admin.layout.sections.form-select>
                <x-admin.layout.sections.form-select :xCloak="!$hasChild" xShow="hasChild > 0" ::disabled="hasChild == 0"
                ...
                <x-admin.layout.sections.form-select :xCloak="!$hasChild" xShow="hasChild == 2"
                ...
                <x-admin.layout.sections.form-select :xCloak="!$hasChild" xShow="hasChild == 2" ::disabled="hasChild < 2"
            ...
            <div class="space-y-5" {{ !$hasChild ? 'x-cloak' : '' }} x-show="hasChild > 0">
                ...
                <x-admin.layout.sections.table :collection="$item->childs" :sortable="true">
                    <x-slot name="ths">
                    ...
                    <x-slot name="tbody">
                        @foreach ($listChilds as $keyChild => $child)
                            <tr class="bg-white border-b optBox">
                                <x-admin.layout.sections.table-td class="text-lg font-bold text-center ordemNumber">
                                    <span>{{ $child->ordem }}</span>
                                    <x-admin.layout.sections.form-input type="hidden" inpName="child_ordem[]"
                                        required :inpValue="$child->ordem" />
                                    <x-admin.layout.sections.form-input type="hidden" inpName="child_id[]" required
                                        :inpValue="$child->id" />
                                ...
                                <x-admin.layout.sections.table-td class="px-6 py-4 space-y-5">
                                    <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-2">
                                        <x-admin.layout.sections.form-select inpName="child_opt1[]"
                                            title="{{ $child->attribute1->name }}" required>
                                            <option disabled selected value="">Selecione</option>
                                            @foreach ($child->attribute1->options as $opt1)
                                                <x-admin.layout.sections.form-select-option :inpValue="$opt1->id"
                                                    :title="$opt1->name" :selected="$child->product_opt1_id == $opt1->id" />
                                            @endforeach
                                        </x-admin.layout.sections.form-select>
                                        @if ($child->attribute2)
                                            <x-admin.layout.sections.form-select inpName="child_opt2[]"
                                                title="{{ $child->attribute2->name }}" required>
                                                <option disabled selected value="">Selecione</option>
                                                @foreach ($child->attribute2->options as $opt2)
                                                    <x-admin.layout.sections.form-select-option :inpValue="$opt2->id"
                                    ...
                                    <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-2">
                                        <x-admin.layout.sections.form-label :inpError="old('child_sku') ? 'child_sku.' . $keyChild : null" inpName="child_sku[]"
                                            title="Código">
                                            <x-admin.layout.sections.form-input inpName="child_sku[]"
                                                placeholder="SKU" :inpValue="$child->sku" required />
                                        </x-admin.layout.sections.form-label>
                                        <x-admin.layout.sections.form-label inpName="child_ean[]" title="EAN">
                                            <x-admin.layout.sections.form-input inpName="child_ean[]"
                                                placeholder="Código de barras" :inpValue="$child->ean" />
                                        </x-admin.layout.sections.form-label>
                                    </x-admin.layout.sections.form-grid>
                                    <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-3">
                                        <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca"
                                            inpName="child_price_cost[]" title="Custo">
                                            <x-admin.layout.sections.form-input inpName="child_price_cost[]"
                                        ...
                                        <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca"
                                            ...
                                            <x-admin.layout.sections.form-input inpName="child_price[]"
                                                placeholder="R$ 0,00" :inpValue="$child->price" required ::disabled="typeOrca"
                                                :disabled="$typeOrca" class="moneyMask " />
                                        </x-admin.layout.sections.form-label>
                                        <x-admin.layout.sections.form-label :xCloak="!$inPromo || $typeOrca"
                                            x-show="!inPromo && !typeOrca" inpName="child_promo_value[]"
                                            title="Preço Promocional">
                                            <x-admin.layout.sections.form-input inpName="child_promo_value[]"
                                        ...
                                        <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca"
                                            ...
                                            <x-admin.layout.sections.form-input inpName="child_weight[]"
                                        ...
                                        <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca"
                                            ...
                                            <x-admin.layout.sections.form-input inpName="child_width[]"
                                ...
                                <x-admin.layout.sections.table-actions-td>
                                    <x-admin.layout.sections.table-action href="javascript:;" class="upOptBtn"
                                        title="Subir Ordenação">
                                        <i class="text-base ti ti-arrow-move-up"></i>
                                    </x-admin.layout.sections.table-action>
                                    <x-admin.layout.sections.table-action href="javascript:;" class="downOptBtn"
                        ...
                        <tr class="hidden bg-white border-b optBoxNew notSortable">
                            <x-admin.layout.sections.table-td class="text-lg font-bold text-center ordemNumber">
                                <span></span>
                                <x-admin.layout.sections.form-input type="hidden" inpName="child_ordem[]" disabled
                                    required />
                                <x-admin.layout.sections.form-input type="hidden" inpName="child_id[]" disabled
                                    required />
                            </x-admin.layout.sections.table-td>
                            <x-admin.layout.sections.table-actions-td>
                                <div class="flex flex-col items-center justify-center">
                            ...
                            <x-admin.layout.sections.table-td class="px-6 py-4 space-y-5">
                                ...
                                <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-2">
                                    <x-admin.layout.sections.form-label inpName="child_sku[]" title="Código">
                                        <x-admin.layout.sections.form-input inpName="child_sku[]" placeholder="SKU"
                                            required disabled />
                                    </x-admin.layout.sections.form-label>
                                    <x-admin.layout.sections.form-label inpName="child_ean[]" title="EAN">
                                        <x-admin.layout.sections.form-input inpName="child_ean[]"
                                ...
                                <x-admin.layout.sections.form-grid gridCols="sm:grid-cols-3">
                                    ...
                                    <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca"
                                        inpName="child_width[]" title="Largura (cm)">
                                        <x-admin.layout.sections.form-input inpName="child_width[]" placeholder="0"
                                            required disabled class="notTypeOrca integerMask" />
                                    </x-admin.layout.sections.form-label>
                                    <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca"
                                        inpName="child_height[]" title="Altura (cm)">
                                        <x-admin.layout.sections.form-input inpName="child_height[]" placeholder="0"
                                            required disabled class="notTypeOrca integerMask" />
                                    </x-admin.layout.sections.form-label>
                                    <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca"
                                        inpName="child_depth[]" title="Comprimento (cm)">
                                        <x-admin.layout.sections.form-input inpName="child_depth[]" placeholder="0"
                                            required disabled class="notTypeOrca integerMask" />
                                    </x-admin.layout.sections.form-label>
                                    <x-admin.layout.sections.form-label :xCloak="$typeOrca" x-show="!typeOrca"
                                        inpName="child_stock[]" title="Estoque">
                                        <x-admin.layout.sections.form-input inpName="child_stock[]" placeholder="0"
                                            required disabled class="notTypeOrca integerMask" />
                                    </x-admin.layout.sections.form-label>
                                </x-admin.layout.sections.form-grid>
                            </x-admin.layout.sections.table-td>
