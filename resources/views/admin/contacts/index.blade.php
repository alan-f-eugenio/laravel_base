    ...
    <x-admin.layout.sections.list-section>
        <x-admin.layout.sections.filter gridCols="sm:grid-cols-4">
            <x-admin.layout.sections.filter-select inpName="seen" title="Status">
                <x-admin.layout.sections.filter-select-option inpName="seen" :inpValue="\App\Models\Contact::STATUS_NOVO" title="Novo" />
                <x-admin.layout.sections.filter-select-option inpName="seen" :inpValue="\App\Models\Contact::STATUS_VISTO" title="Visto" />
